                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                            ...
                            Align(
                              ...
                              child: CupertinoButton(
                                ...
                                child: Container(
                                  height: 64,
                                  width: 64,
                                  decoration: BoxDecoration(color: const Color(0xFF111111).withOpacity(0.02), border: Border.all(color: Colors.white), borderRadius: BorderRadius.circular(100)),
                      ...
                      const Text('Создать аккаунт', style: TextStyle(fontSize: 32, fontWeight: FontWeight.w500)),
                      const SizedBox(height: 32),
                      CustomTextField(hint: 'ФИО', iconPath: 'assets/icons/name.svg', controller: _fioController),
                      CustomTextField(hint: 'ИИН', iconPath: 'assets/icons/iin.svg', controller: _iinController),
                      CustomTextField(hint: 'Город', iconPath: 'assets/icons/city.svg', controller: _cityController),
                      CustomTextField(
                        hint: 'Дата рождения',
              ...
              Positioned(
                ...
                child: CupertinoButton(
                  ...
                  child: Container(
                    ...
                    child: const Center(child: Text('Войти', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w500))),
                  ),
                ),
              ),
            ],
